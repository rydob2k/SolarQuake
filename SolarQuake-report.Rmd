...
Using the just average earthquake frequency as a predictor gave the best result at `14.01037`, followed closely by the linear model with `14.01053`.  
The kNN model gave a resulting RMSE slightly higher at `14.04901`.  
The random forest model was the worst performing of the four models with an RMSE of `14.19991`.  
...
4. Earthquakes Data Set - https://www.kaggle.com/datasets/garrickhague/world-earthquake-data-from-1906-2022/data